...
void coord_test(double ref_x, double ref_y, double theta, double x, double y, const vector<double> &maps_x, const vector<double> &maps_y) {
  ...
  double x_pt = (x*cos(ref_yaw) - y*sin(ref_yaw));
  double y_pt = (x*sin(ref_yaw) + y*cos(ref_yaw));
  x_pt += ref_x;
  y_pt += ref_y;
  cout << "back x " << x_pt << endl;
  cout << "back y " << y_pt << endl << endl;
